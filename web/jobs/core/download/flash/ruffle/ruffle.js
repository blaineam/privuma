(() => {
    ...
    t = {
      ...
      53: (e, n, t) => {
        ...
        const a = t(136),
          r = t(56);
        function o(e, n, ...t) {
          if ("function" == typeof e) return e({ ...n, children: t });
          const { finalTag: o, finalAttrs: i } = (0, r.applyTsxTag)(e, n),
            s = (0, r.createDomElement)(o, i);
          return i && (0, a.setAttributes)(s, i), (0, r.applyChildren)(s, t), s;
        }
        n.h = o;
        ...
        function t(e, n) {
          n instanceof Element
            ...
            : "string" == typeof n || "number" == typeof n
              ? e.appendChild(document.createTextNode(n.toString()))
              : console.warn("Unknown type to append: ", n);
        }
        Object.defineProperty(n, "__esModule", { value: !0 }),
          ...
          (n.createDomElement = function (e, n) {
            const t = n?.is ? { is: n.is } : void 0;
            return n?.xmlns
              ? document.createElementNS(n.xmlns, e, t)
          ...
          (n.applyTsxTag = function (e, n) {
            ...
            a &&
              "tsxTag" in a &&
              ((t = a.tsxTag),
              !a.is && e.includes("-") && (a = { ...a, is: e }));
            return { finalTag: t, finalAttrs: a };
          });
      },
      65: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 }),
        ...
        function i(e) {
          return e
            ? "string" == typeof e
              ? [e]
              : Array.isArray(e)
                ? e.flatMap(i).filter(a)
                : t(e).filter(a)
            : o;
        }
      },
      124: (e, n, t) => {
        e.exports = t.p + "64928eb47d201ed000e6.wasm";
      },
      125: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
      136: (e, n, t) => {
        Object.defineProperty(n, "__esModule", { value: !0 }),
          (n.setAttributes = function (e, n) {
            for (const t of Object.keys(n)) {
              ...
              const i = n[t];
              if ("class" === t) {
                const n = (0, a.classnames)(i);
                n && e.setAttribute(t, n);
              } else if ("ref" === t) i.current = e;
              else if (o.test(t)) {
        ...
        const a = t(665);
        function r(e, n) {
          for (const t of Object.keys(e)) t in n && (n[t] = e[t]);
        }
        const o = /^on\p{Lu}/u;
      },
      269: (e, n) => {
      ...
      325: (e, n, t) => {
        Object.defineProperty(n, "__esModule", { value: !0 }),
          (n.defineCustomElement = function (e, n, t) {
            return customElements.define(e, n, t), (n) => (0, a.jsx)(e, n);
          });
        const a = t(553);
      },
      460: (e, n) => {
      ...
      553: (e, n, t) => {
        ...
        function o(e, n) {
          ...
          const { children: t, ...o } = n,
            { finalTag: i, finalAttrs: s } = (0, r.applyTsxTag)(e, o),
            l = (0, r.createDomElement)(i, s);
          return (0, a.setAttributes)(l, s), (0, r.applyChildren)(l, [t]), l;
        }
      },
      665: function (e, n, t) {
        var a =
      ...
      797: (e, n, t) => {
        e.exports = t.p + "285b6fe179b0fd173f21.wasm";
      },
      836: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
  ...
  (r.m = t),
    ...
    (r.u = (e) =>
      "core.ruffle." +
      { 482: "185f5333ea5c217bff2d", 655: "f1f4c5582b06c4ac3d59" }[e] +
      ".js"),
    (r.g = (function () {
  ...
  class o {
    ...
    hasPrecedenceOver(e) {
      ...
      if (null !== this.buildIdent && null !== e.buildIdent) {
        ...
        for (
          let t = 0;
          t < this.buildIdent.length && t < e.buildIdent.length;
          t += 1
        ) {
  ...
  class i {
    ...
    static fromRequirementString(e) {
      ...
      const a = [];
      for (const e of n)
        if ("||" === e) t.length > 0 && (a.push(t), (t = []));
        else if (e.length > 0) {
          const n = /[0-9]/.exec(e);
          if (n) {
            const a = e.slice(0, n.index).trim(),
              r = o.fromSemver(e.slice(n.index).trim());
            t.push({ comparator: a, version: r });
          }
        }
      return t.length > 0 && a.push(t), new i(a);
    }
  }
  class s {
    constructor(e) {
  ...
  const l = {
    versionNumber: "0.2.0-nightly.2025.12.14",
    versionName: "0.2.0-nightly.2025.12.14",
    versionChannel: "nightly",
    buildDate: "2025-12-14T00:08:15.667Z",
    commitHash: "de228f4a181e959366950583c55b4a36209c05d2",
  };
  var u;
  !(function (e) {
  ...
  !(function (e) {
    ...
    (function (e) {
      (e.Always = "always"), (e.Never = "never"), (e.Smart = "smart");
    })(k || (k = {})),
    (function (e) {
      (e.Embedded = "embedded"), (e.Canvas = "canvas");
    })(y || (y = {})),
    (function (e) {
      (e.South = "south"),
        (e.East = "east"),
        (e.North = "north"),
        (e.West = "west"),
        (e.LeftTrigger = "left-trigger"),
        (e.LeftTrigger2 = "left-trigger-2"),
        (e.RightTrigger = "right-trigger"),
        (e.RightTrigger2 = "right-trigger-2"),
        (e.Select = "select"),
        (e.Start = "start"),
        (e.DPadUp = "dpad-up"),
        (e.DPadDown = "dpad-down"),
        (e.DPadLeft = "dpad-left"),
        (e.DPadRight = "dpad-right");
    })(R || (R = {}));
  const z = {
    allowScriptAccess: !1,
    parameters: {},
    ...
    letterbox: d.Fullscreen,
    unmuteOverlay: f.Visible,
    upgradeToHttps: !0,
    ...
    openUrlMode: b.Allow,
    allowNetworking: w.All,
    openInNewTab: null,
    socketProxy: [],
    fontSources: [],
    defaultFonts: {},
    credentialAllowList: [],
    playerRuntime: g.FlashPlayer,
  ...
  class A extends j {
    static supportsValue(e) {
      ...
      if (e instanceof j) return A.supportsValue(e.valueOf());
      if ("Temporal" in globalThis) {
        const n = globalThis.Temporal;
        if (
          e instanceof n.Instant ||
          e instanceof n.PlainDateTime ||
          e instanceof n.PlainDate ||
          e instanceof n.PlainMonthDay ||
          e instanceof n.PlainTime ||
          e instanceof n.PlainYearMonth
        )
          return !0;
      }
      return !1;
  ...
  function E(e, n, t) {
    if (t === n) return !0;
    if (t instanceof C && n instanceof C && t.value === n.value) return !0;
    if (n instanceof C && "string" == typeof t) {
  ...
  function q(e, n) {
    ...
    for (const r of n)
      "narg" === r.type ? (a[r.name] = P(e, r.value)) : t.push(P(e, r));
  ...
  function P(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new C(n.value, { minimumFractionDigits: n.precision });
      case "var":
        return (function (e, { name: n }) {
          ...
          switch (typeof t) {
            ...
            case "number":
              return new C(t);
            case "object":
              if (A.supportsValue(t)) return new A(t);
            default:
              return (
                e.reportError(
                  new TypeError(
      ...
      case "mesg":
        return (function (e, { name: n, attr: t }) {
          ...
          if (t) {
            ...
            return r
              ? M(e, r)
              : (e.reportError(new ReferenceError(`Unknown attribute: ${t}`)),
                new S(`${n}.${t}`));
          }
          if (a.value) return M(e, a.value);
      ...
      case "term":
        return (function (e, { name: n, attr: t, args: a }) {
          ...
          if (!o)
            return (
              e.reportError(new ReferenceError(`Unknown term: ${r}`)), new S(r)
            );
          if (t) {
            const n = o.attributes[t];
            if (n) {
              e.params = q(e, a).named;
              const t = M(e, n);
      ...
      case "func":
        return (function (e, { name: n, args: t }) {
          ...
          try {
            ...
            return e.reportError(t), new S(`${n}()`);
          }
        })(e, n);
      case "select":
        return (function (e, { selector: n, variants: t, star: a }) {
          let r = P(e, n);
          if (r instanceof S) return F(e, t, a);
          for (const n of t) {
            if (E(e, r, P(e, n.key))) return M(e, n.value);
          }
          return F(e, t, a);
        })(e, n);
      default:
  ...
  function D(e, n) {
    ...
    for (const r of n)
      if ("string" != typeof r) {
        ...
        a && t.push("\u2068"),
          t.push(P(e, r).toString(e)),
          a && t.push("\u2069");
      } else t.push(e.bundle._transform(r));
    return e.dirty.delete(n), t.join("");
  }
  function M(e, n) {
    return "string" == typeof n ? e.bundle._transform(n) : D(e, n);
  }
  class O {
    constructor(e, n, t) {
  ...
  function T(e, n) {
    let t = e[0];
    if (t instanceof S) return new S(`NUMBER(${t.valueOf()})`);
    if (t instanceof C) return new C(t.valueOf(), { ...t.opts, ...$(n, I) });
    if (t instanceof A) return new C(t.toNumber(), { ...$(n, I) });
  ...
  function L(e, n) {
    let t = e[0];
    if (t instanceof S) return new S(`DATETIME(${t.valueOf()})`);
    if (t instanceof A || t instanceof C) return new A(t, $(n, W));
  ...
  class U {
    constructor(
      e,
      { functions: n, useIsolating: t = !0, transform: a = (e) => e } = {},
    ) {
      (this._terms = new Map()),
        (this._messages = new Map()),
        (this.locales = Array.isArray(e) ? e : [e]),
        (this._functions = { NUMBER: T, DATETIME: L, ...n }),
        (this._useIsolating = t),
        (this._transform = a),
        (this._intls = (function (e) {
          const n = Array.isArray(e) ? e.join(" ") : e;
          let t = N.get(n);
          return void 0 === t && ((t = new Map()), N.set(n, t)), t;
        })(e));
    }
    hasMessage(e) {
    ...
    formatPattern(e, n = null, t = null) {
      ...
      let a = new O(this, t, n);
      try {
        return D(a, e).toString(a);
      } catch (e) {
        if (a.errors && e instanceof Error)
          return a.errors.push(e), new S().toString(a);
        throw e;
      }
    }
  }
  const _ = /^(-?[a-zA-Z][\w-]*) *= */gm,
    ...
    H = /(-?[0-9]+(?:\.([0-9]+))?)/y,
    J = /([a-zA-Z][\w-]*)/y,
    K = /([$-])?([a-zA-Z][\w-]*)(?:\.([a-zA-Z][\w-]*))?/y,
    Z = /^[A-Z][A-Z0-9_-]*$/,
    Q = /([^{}\n\r]+)/y,
    G = /([^\\"\n\r]*)/y,
    Y = /\\([\\"])/y,
    X = /\\u([a-fA-F0-9]{4})|\\U([a-fA-F0-9]{6})/y,
    ee = /^\n+/,
    ne = / +$/,
    te = / *\r?\n/g,
    ae = /( *)$/,
    ...
    constructor(e) {
      ...
      function c() {
        ...
        if (r(ue)) {
          ...
          return r(oe, SyntaxError), { type: "select", selector: e, ...n };
        }
      ...
      function d() {
        ...
        if (t(K)) {
          ...
          if (r(le)) {
            ...
            if (Z.test(a)) return { type: "func", name: a, args: o };
            throw new SyntaxError("Function names must be all upper-case");
          }
          return "-" === t
            ? { type: "term", name: a, attr: i, args: [] }
            : { type: "mesg", name: a, attr: i };
        }
        return p();
      }
      function f() {
  ...
  function we(e, n, { strategy: t = "filtering", defaultLocale: a } = {}) {
    const r = (function (e, n, t) {
      const a = new Set(),
        r = new Map();
      for (let e of n) new ve(e).isWellFormed && r.set(e, new ve(e));
      e: for (const n of e) {
        ...
        if (void 0 !== o.language) {
          ...
          if (o.addLikelySubtags())
            for (const [e, n] of r.entries())
              if (n.matches(o, !0, !1)) {
                if ((a.add(e), r.delete(e), "lookup" === t))
                  return Array.from(a);
                if ("filtering" === t) continue;
                continue e;
              }
  ...
  function ke() {
    if ("function" != typeof Map.prototype.set) {
      const e = Map,
        n = document.createElement("iframe");
      return (
        (n.style.display = "none"),
        document.documentElement.append(n),
        (Map = n.contentWindow.Map),
        n.remove(),
        e
      );
    }
  ...
  for (const [e, n] of Object.entries(ze)) {
    ...
    if (n) {
      ...
      for (const [r, o] of Object.entries(n))
        if (o) {
          a ??= ke();
          for (const n of t.addResource(new me(o)))
  ...
  function Ce(e, n) {
    const t = ke(),
      a = we(navigator.languages, Object.keys(je), { defaultLocale: "en-US" });
    for (const t in a) {
      const r = Se(a[t], e, n);
      if (r) return r;
    }
    return console.error(`Unknown text key '${e}'`), ye(t), e;
  }
  function Ae(e, n) {
  ...
  const Ee = navigator.userAgent.includes("Mac OS X") ? "Command" : "Ctrl";
  const Fe = document.createElement("template");
  Fe.content.appendChild(
    (0, x.jsx)(function () {
      return (0, x.jsx)("style", {
        children:
    ...
    Fe.content.appendChild(
      (0, x.jsx)(function () {
        return (0, x.jsx)("style", { id: "dynamic-styles" });
      }, {}),
    ),
    Fe.content.appendChild(
      (0, x.jsx)(function () {
      ...
      (0, x.jsx)(function () {
        return (0, x.jsxs)("div", {
          ...
          children: [
            ...
            (0, x.jsx)("div", {
              class: "loadbar",
              children: (0, x.jsx)("div", { class: "loadbar-inner" }),
            }),
          ],
        });
      }, {}),
      ...
      (0, x.jsx)(function () {
        return (0, x.jsx)("div", {
          ...
          children: (0, x.jsxs)("div", {
            ...
            class: "modal-area",
            children: [
              (0, x.jsx)("span", { class: "close-modal" }),
              (0, x.jsx)("div", {
                class: "general-save-options",
                children: (0, x.jsx)("span", { class: "modal-button" }),
              }),
              (0, x.jsx)("table", { id: "local-saves" }),
            ],
          }),
        });
      }, {}),
        ...
        return (0, x.jsx)("div", {
          ...
          children: (0, x.jsx)("div", {
            ...
            children: (0, x.jsxs)("div", {
              id: "volume-controls",
              children: [
                (0, x.jsx)("input", { id: "mute-checkbox", type: "checkbox" }),
                (0, x.jsx)("label", {
                  id: "volume-mute",
                  for: "mute-checkbox",
                ...
                (0, x.jsx)("span", { id: "volume-slider-text" }),
                (0, x.jsx)("span", { class: "close-modal" }),
              ],
            }),
          }),
      ...
      (0, x.jsx)(function () {
        return (0, x.jsx)("div", {
          ...
          children: (0, x.jsxs)("div", {
            ...
            children: [
              (0, x.jsx)("span", { class: "close-modal" }),
              (0, x.jsx)("h2", { children: Ce("clipboard-message-title") }),
              (0, x.jsx)("p", { id: "clipboard-modal-description" }),
              (0, x.jsxs)("p", {
                children: [
                  (0, x.jsxs)("b", { children: [Ee, "+C"] }),
                  (0, x.jsx)("span", {
              ...
              (0, x.jsxs)("p", {
                children: [
                  (0, x.jsxs)("b", { children: [Ee, "+X"] }),
                  (0, x.jsx)("span", { children: Ce("clipboard-message-cut") }),
                ],
              }),
              (0, x.jsxs)("p", {
                children: [
                  (0, x.jsxs)("b", { children: [Ee, "+V"] }),
                  (0, x.jsx)("span", {
    ...
    Fe.content.appendChild(
      (0, x.jsx)(function () {
        return (0, x.jsx)("div", {
          ...
          class: "hidden",
          children: (0, x.jsx)("ul", { id: "context-menu" }),
        });
      }, {}),
    );
  const qe = "application/x-shockwave-flash",
    Pe = "application/futuresplash",
    De = "application/x-shockwave-flash2-preview",
    Me = "application/vnd.adobe.flash.movie";
  function Oe(e, n) {
    const t = (function (e) {
      let n = "";
      try {
  ...
  try {
    if (
      ...
      e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        ($e = new URL(".", e)),
        (Ie = $e.protocol.includes("extension"));
    }
  } catch (e) {
    console.warn("Unable to get currentScript URL", e);
  }
  const Te = "https://ruffle.rs";
  ...
  class Ne extends Error {
    constructor(e) {
      super("Failed to load Ruffle WASM"), (this.cause = e);
    }
  }
  ...
  const Ve = {
    ...
    createReportOrUpdate() {
      return Be() ? this.UpdateRuffle : this.CreateReport;
    },
    openWiki: (e, n) => ({
      type: "open_link",
      ...
      u = () => {
        s.current.classList.add("details"),
          s.current.replaceChildren(
            (0, x.jsx)("textarea", { readOnly: !0, children: r }),
          );
      };
    (e.textContent = ""),
      e.appendChild(
        (0, x.jsxs)("div", {
          ...
          children: [
            ...
            (0, x.jsx)("div", { id: "panic-body", ref: s, children: o }),
            (0, x.jsx)("div", {
              id: "panic-footer",
              children: (0, x.jsx)("ul", {
                children: i.map((e) =>
  ...
  async function Xe(e) {
    null === Ye &&
      (Ye = (async function (e) {
        xe();
        const n = (await Promise.all([Je(), Ge(), Ze(), Qe(), Ke()])).every(
          Boolean,
        );
        n ||
          console.log(
          ...
          ot.options.onFirstLoad?.(),
          (ot.options.onFirstLoad = () => {});
        const {
          default: t,
          RuffleInstanceBuilder: a,
          ZipWriter: o,
        } = await (n
          ...
          i = new Response(
            new ReadableStream({
              async start(n) {
                ...
                if (!r) throw "Response had no body";
                for (e(t, a); ; ) {
                  const { done: o, value: i } = await r.read();
                  if (o) break;
                  i?.byteLength && (t += i?.byteLength), n.enqueue(i), e(t, a);
                }
                n.close();
              },
            }),
        ...
        return await t({ module_or_path: i }), [a, o];
      })(e));
    const n = await Ye;
  ...
  function nn(e, n) {
    ...
    if (void 0 !== window.customElements)
      for (; a < 999; ) {
        let t = e;
        if (
          (a > 0 && (t = t + "-" + a), void 0 === window.customElements.get(t))
        )
          return (
            window.customElements.define(t, n),
            (en[e] = { class: n, name: t, internalName: e }),
            t
          );
        a += 1;
      }
  ...
  function an(e, n) {
    if (
      (tn(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      tn(n.backgroundColor) &&
      ...
      tn(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps),
      tn(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules),
      tn(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      tn(n.base) && e.setBaseUrl(n.base),
      tn(n.menu) && e.setShowMenu(n.menu),
      tn(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      tn(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      tn(n.forceAlign) && e.setForceAlign(n.forceAlign),
      tn(n.quality)
        ...
        : void 0 !== window.orientation &&
          ...
          e.setQuality("low")),
      tn(n.scale) && e.setScale(n.scale.toLowerCase()),
      tn(n.forceScale) && e.setForceScale(n.forceScale),
      tn(n.frameRate) && e.setFrameRate(n.frameRate),
      tn(n.wmode) && e.setWmode(n.wmode),
      tn(n.logLevel) && e.setLogLevel(n.logLevel),
      tn(n.maxExecutionDuration) &&
      ...
      tn(n.playerVersion) && e.setPlayerVersion(n.playerVersion),
      tn(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer),
      tn(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()),
      tn(n.allowNetworking) &&
        e.setAllowNetworking(n.allowNetworking.toLowerCase()),
      tn(n.credentialAllowList) &&
        e.setCredentialAllowList(n.credentialAllowList),
      tn(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime),
      tn(n.socketProxy))
    )
      for (const t of n.socketProxy)
        e.addSocketProxy(t.host, t.port, t.proxyUrl);
    if (tn(n.gamepadButtonMapping))
      for (const [t, a] of Object.entries(n.gamepadButtonMapping))
        e.addGamepadButtonMapping(t, a);
    if (tn(n.urlRewriteRules))
      for (const [t, a] of n.urlRewriteRules)
        if (t instanceof RegExp) e.addUrlRewriteRule(t, a);
        else {
          const n = t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"),
            r = new RegExp(`^${n}$`),
            o = a.replace(/\$/g, "$$$$");
    ...
    tn(n.scrollingBehavior) && e.setScrollingBehavior(n.scrollingBehavior),
      tn(n.deviceFontRenderer) && e.setDeviceFontRenderer(n.deviceFontRenderer);
  }
  const rn = /^\s*(\d+(\.\d+)?(%)?)/;
  let on = !1;
  function sn(e) {
  ...
  class un {
    constructor(e, n, t) {
      (this.contextMenuForceDisabled = !1),
        ...
        (this.onFSCommand = []),
        (this.config = {}),
        (this.SaveRow = ({ rowKey: e, solName: n, solData: t }) =>
          (0, x.jsxs)("tr", {
            children: [
              (0, x.jsx)("td", { title: e, children: n }),
              (0, x.jsx)("td", {
                children: (0, x.jsx)("span", {
                  class: "save-option",
                  id: "download-save",
                  title: Ce("save-download"),
                  onClick: () =>
                    hn(
                      (function (e, n) {
                        const t = vn(e);
      ...
      a &&
        (a.addEventListener("click", this.backupSaves.bind(this)),
        (a.innerText = Ce("save-backup-all")));
    ...
    addFSCommandHandler(e) {
      this.onFSCommand.push(e);
    }
    callFSCommand(e, n) {
      if (0 === this.onFSCommand.length) return !1;
      for (const t of this.onFSCommand) t(e, n);
      return !0;
    }
    ...
    updateStyles() {
      if (this.dynamicStyles.sheet) {
        ...
        if (null != e) {
          ...
          t && this.dynamicStyles.sheet.insertRule(`:host { ${t} }`);
        }
        ...
        const t = this.element.attributes.getNamedItem("height");
        if (null != t) {
          const e = un.htmlDimensionToCssDimension(t.value);
          null !== e &&
        ...
        if (!pn(this.element))
          try {
            (this.loadedConfig = {
              ...z,
              ...(n && "url" in e
                ? { allowScriptAccess: wn("samedomain", e.url) }
                : {}),
    ...
    confirmReloadSave(e, n, t) {
      if (gn(n) && localStorage[e]) {
        if (!t) {
          if (!confirm(Ce("save-delete-prompt"))) return;
        }
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              Ce("save-reload-prompt", { action: t ? "replace" : "delete" }),
            ) &&
            this.loadedConfig &&
            (this.destroy(),
      ...
      (e.textContent = ""),
        Object.keys(localStorage).forEach((n) => {
          ...
          t &&
            ...
            gn(a) &&
            e.appendChild(
              (0, x.jsx)(this.SaveRow, { rowKey: n, solName: t, solData: a }),
            );
        });
    }
    async backupSaves() {
      ...
      hn(new Blob([e.save()], { type: "application/zip" }), "saves.zip");
    }
    openHardwareAccelerationModal() {
      this.hardwareAccelerationModal.classList.remove("hidden");
    }
    async openSaveManager() {
      this.populateSaves(), this.saveManager.classList.remove("hidden");
    }
    openVolumeControls() {
    ...
    pointerDown(e) {
      (this.pointerDownPosition = new ln(e.pageX, e.pageY)),
        (this.pointerMoveMaxDistance = 0),
    ...
    checkLongPressMovement(e) {
      if (null !== this.pointerDownPosition) {
        const n = new ln(e.pageX, e.pageY),
    ...
    showContextMenu(e) {
      ...
      for (const e of this.contextMenuItems())
        if (null === e)
          ...
          const { text: n, onClick: t, enabled: a } = e,
            r = (0, x.jsx)("li", {
              class: { "menu-item": !0, disabled: !1 === a },
              "data-text": n,
              children: n,
            });
          if ((this.contextMenuElement.appendChild(r), !1 !== a)) {
            const e = async (e) => {
              e.preventDefault(),
                e.stopPropagation(),
                await t(e),
      ...
      const n = this.element.getBoundingClientRect(),
        ...
        r = Math.max(0, e.clientX + t.width - a.clientWidth),
        o = Math.max(0, e.clientY + t.height - a.clientHeight),
        i = e.clientX - n.x - r,
        s = e.clientY - n.y - o,
    ...
    panic(e) {
        ...
        const n = this.loadedConfig?.openInNewTab,
          t =
            this.loadedConfig && "url" in this.loadedConfig
              ...
              : void 0;
        if (n && t) return void this.addOpenInNewTabMessage(n, t);
        e = e.cause;
      }
      const t = Object.assign([], { stackIndex: -1, avmStackIndex: -1 });
      if ((t.push("# Error Info\n"), e instanceof Error)) {
        if (
          (t.push(`Error name: ${e.name}\n`),
          t.push(`Error message: ${e.message}\n`),
          e.stack)
        ) {
          const n = t.push(`Error stack:\n\`\`\`\n${e.stack}\n\`\`\`\n`) - 1;
          if (e.avmStack) {
            const n =
              t.push(
      ...
      t.push(this.getPanicData()),
        He(this.container, n, t, this.swfUrl),
        this.destroy();
    }
    addOpenInNewTabMessage(e, n) {
      const t = new URL(n);
      if (this.loadedConfig?.parameters) {
        const e = sn(this.loadedConfig?.parameters);
        Object.entries(e).forEach(([e, n]) => {
          t.searchParams.set(e, n);
        });
      }
      this.hideSplashScreen();
      const a = (0, x.jsxs)("div", {
        children: [
      ...
      this.displayMessageOrElement(a, !0);
    }
    displayRootMovieDownloadFailedMessage(e, n) {
      const t = this.loadedConfig?.openInNewTab;
      if (t && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        this.addOpenInNewTabMessage(t, this.swfUrl);
      else {
        const t = n.includes("HTTP Status is not OK:"),
          a = e ? new Le(this.swfUrl) : new We(this.swfUrl, t);
        this.panic(a);
      }
    }
    displayMessageOrElement(e, n) {
      const t =
          e instanceof HTMLDivElement ? e : (0, x.jsx)("p", { children: e }),
        a = n
          ? null
          : (0, x.jsx)("div", {
        ...
        r = (0, x.jsx)("div", {
          id: "message-overlay",
          children: (0, x.jsxs)("div", { class: "message", children: [t, a] }),
        });
    ...
    displayRestoredFromBfcacheMessage() {
      if (null !== this.container.querySelector("#message-overlay")) return;
    ...
    setMetadata(e) {
      (this.metadata = e),
        (this._readyState = u.Loaded),
        this.hideSplashScreen(),
        this.element.dispatchEvent(new CustomEvent(un.LOADED_METADATA)),
        this.element.dispatchEvent(new CustomEvent(un.LOADED_DATA));
    }
  }
  (un.LOADED_METADATA = "loadedmetadata"), (un.LOADED_DATA = "loadeddata");
  class cn {
    constructor(e, n) {
  ...
  function dn(e, n) {
    ...
    const r = wn(n("allowScriptAccess"), e);
    ...
    const m = n("wmode");
    null !== m && (t.wmode = m);
    const p = n("fullScreenAspectRatio");
    return null !== p && (t.fullScreenAspectRatio = p), t;
  }
  function fn(e) {
    if (e) {
      let n = "",
        t = "";
      try {
        const a = new URL(e, Te);
        (n = a.pathname), (t = a.hostname);
      } catch (e) {}
      if (
        n.startsWith("/v/") &&
        /^(?:(?:www\.|m\.)?youtube(?:-nocookie)?\.com)|(?:youtu\.be)$/i.test(t)
      )
        return !0;
    }
    return !1;
    ...
    if (t)
      try {
        ...
        "http:" !== r.protocol ||
          ...
          ((r.protocol = "https:"), e.setAttribute(n, r.toString()));
      } catch (e) {}
  }
  function pn(e) {
  ...
  function gn(e) {
    try {
      ...
      return (
        ...
        191 === n.charCodeAt(1) &&
        "TCSO" === n.slice(6, 10) &&
        [0, 4, 0, 0, 0, 0].every((e, t) => n.charCodeAt(10 + t) === e)
      );
    } catch (e) {
      return !1;
    }
  ...
  var kn,
    yn = function (e, n, t, a, r) {
      ...
      return "a" === a ? r.call(e, t) : r ? (r.value = t) : n.set(e, t), t;
    },
    Rn = function (e, n, t, a) {
      if ("a" === t && !a)
  ...
  class xn {
    constructor(e) {
      kn.set(this, void 0), yn(this, kn, e, "f");
    }
    addFSCommandHandler(e) {
      Rn(this, kn, "f").addFSCommandHandler(e);
    }
    get readyState() {
      return Rn(this, kn, "f")._readyState;
    }
    get metadata() {
      return Rn(this, kn, "f").metadata;
    }
    get loadedConfig() {
      return Rn(this, kn, "f").loadedConfig ?? null;
    }
    async reload() {
      await Rn(this, kn, "f").reload();
    }
    async load(e, n = !1) {
      await Rn(this, kn, "f").load(e, n);
    }
    resume() {
      Rn(this, kn, "f").play();
    }
    get isPlaying() {
      return Rn(this, kn, "f").isPlaying;
    }
    get volume() {
      return Rn(this, kn, "f").volume;
    }
    set volume(e) {
      Rn(this, kn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return Rn(this, kn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return Rn(this, kn, "f").isFullscreen;
    }
    setFullscreen(e) {
      Rn(this, kn, "f").setFullscreen(e);
    }
    requestFullscreen() {
      Rn(this, kn, "f").enterFullscreen();
    }
    exitFullscreen() {
      Rn(this, kn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await Rn(this, kn, "f").downloadSwf();
    }
    displayMessage(e) {
      Rn(this, kn, "f").displayMessage(e);
    }
    suspend() {
      Rn(this, kn, "f").pause();
    }
    ...
    set traceObserver(e) {
      Rn(this, kn, "f").traceObserver = e;
    }
    get config() {
      return Rn(this, kn, "f").config;
    }
    set config(e) {
      Rn(this, kn, "f").config = e;
    }
    callExternalInterface(e, ...n) {
      return Rn(this, kn, "f").callExternalInterface(e, n);
    }
  }
  kn = new WeakMap();
  var zn,
  ...
  class An extends HTMLElement {
    ...
    get readyState() {
      return Sn(this, zn, "f")._readyState;
    }
    get metadata() {
      return Sn(this, zn, "f").metadata;
    }
    constructor() {
      super(),
        zn.set(this, void 0),
            ...
            (e) => {
              try {
                Object.defineProperty(this, e, {
                  value: (...n) =>
                    Sn(this, zn, "f").callExternalInterface(e, n),
                  configurable: !0,
                });
              } catch (n) {
                console.warn(
        ...
        Sn(this, zn, "f").addFSCommandHandler((e, n) => {
          Sn(this, jn, "f")?.call(this, e, n);
        });
    }
    ruffle(e) {
      if (1 === (e ?? 1)) return new xn(Sn(this, zn, "f"));
      throw new Error(`Version ${e} not supported.`);
    }
    get loadedConfig() {
      return Sn(this, zn, "f").loadedConfig ?? null;
    }
    connectedCallback() {
      Sn(this, zn, "f").updateStyles();
    }
    static get observedAttributes() {
      return ["width", "height", "align"];
    }
    attributeChangedCallback(e, n, t) {
      An.observedAttributes.includes(e) && Sn(this, zn, "f").updateStyles();
    }
    disconnectedCallback() {
      Sn(this, zn, "f").destroy();
    }
    async reload() {
      await Sn(this, zn, "f").reload();
    }
    async load(e, n = !1) {
      await Sn(this, zn, "f").load(e, n);
    }
    play() {
      Sn(this, zn, "f").play();
    }
    get isPlaying() {
      return Sn(this, zn, "f").isPlaying;
    }
    get volume() {
      return Sn(this, zn, "f").volume;
    }
    set volume(e) {
      Sn(this, zn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return Sn(this, zn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return Sn(this, zn, "f").isFullscreen;
    }
    setFullscreen(e) {
      Sn(this, zn, "f").setFullscreen(e);
    }
    enterFullscreen() {
      Sn(this, zn, "f").enterFullscreen();
    }
    exitFullscreen() {
      Sn(this, zn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await Sn(this, zn, "f").downloadSwf();
    }
    pause() {
      Sn(this, zn, "f").pause();
    }
    set traceObserver(e) {
      Sn(this, zn, "f").traceObserver = e;
    }
    debugPlayerInfo() {
      return "";
    }
    PercentLoaded() {
      return Sn(this, zn, "f")._readyState === u.Loaded ? 100 : 0;
    }
    get config() {
      return Sn(this, zn, "f").config;
    }
    set config(e) {
      Sn(this, zn, "f").config = e;
    }
    displayMessage(e) {
      Sn(this, zn, "f").displayMessage(e);
    }
  }
  function En(e, n) {
    if (e) {
      for (const t of e.attributes)
        if (t.specified) {
          if ("title" === t.name && "Adobe Flash Player" === t.value) continue;
          try {
      ...
      for (const t of Array.from(e.children)) n.appendChild(t);
    }
  }
  (zn = new WeakMap()), (jn = new WeakMap());
  class Fn extends An {
    connectedCallback() {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !pn(e) && (fn(n) ? (mn(e, "src"), !1) : Oe(n, t));
    }
    static fromNativeEmbedElement(e) {
      const n = nn("ruffle-embed", Fn),
  ...
  class Pn extends An {
    constructor() {
      super(...arguments), (this.params = {});
    }
    connectedCallback() {
      super.connectedCallback(), (this.params = qn(this));
      let e = null;
      if (
        (this.attributes.getNamedItem("data")
          ? (e = this.attributes.getNamedItem("data")?.value)
          : this.params.movie && (e = this.params.movie),
        e)
      ) {
    ...
    debugPlayerInfo() {
      ...
      return (
        this.attributes.getNamedItem("data")
          ? (n = this.attributes.getNamedItem("data")?.value)
    ...
    static isInterdictable(e) {
      ...
      let r;
      if (n) {
        if (fn(n)) return mn(e, "data"), !1;
        r = n;
      } else {
        if (!a || !a.movie) return !1;
        if (fn(a.movie)) {
  ...
  class _n {
    ...
    install(e) {
      const n = new Bn(e),
        t = Un(this, Dn, "f").length;
      Un(this, Dn, "f").push(n),
        (Un(this, Mn, "f")[e.type] = n),
    ...
    item(e) {
      return Un(this, Dn, "f")[e >>> 0];
    }
    namedItem(e) {
      return Un(this, Mn, "f")[e];
    }
    get length() {
      return Un(this, Dn, "f").length;
    }
    [((Dn = new WeakMap()), (Mn = new WeakMap()), Symbol.iterator)]() {
      return Un(this, Dn, "f")[Symbol.iterator]();
    }
  ...
  class Bn {
    constructor(e) {
      On.set(this, void 0), Nn(this, On, e, "f");
    }
    get type() {
      return Un(this, On, "f").type;
    }
    get description() {
      return Un(this, On, "f").description;
    }
    get suffixes() {
      return Un(this, On, "f").suffixes;
    }
    get enabledPlugin() {
      return Un(this, On, "f").enabledPlugin;
    }
    get [((On = new WeakMap()), Symbol.toStringTag)]() {
      return "MimeType";
    }
  }
  class Vn extends _n {
  ...
  class Hn {
    ...
    install(e) {
      const n = Un(this, Wn, "f").length;
      Un(this, Wn, "f").push(e),
        (Un(this, Ln, "f")[e.name] = e),
    ...
    item(e) {
      return Un(this, Wn, "f")[e >>> 0];
    }
    namedItem(e) {
      return Un(this, Ln, "f")[e];
    }
    refresh() {}
    [((Wn = new WeakMap()), (Ln = new WeakMap()), Symbol.iterator)]() {
      return Un(this, Wn, "f")[Symbol.iterator]();
    }
    get [Symbol.toStringTag]() {
      return "PluginArray";
    }
    get length() {
      return Un(this, Wn, "f").length;
    }
  }
  const Jn = new Vn("Shockwave Flash", "Shockwave Flash 32.0 r0", "ruffle.js");
  Jn.install({
    type: Pe,
  ...
  function et() {
    try {
      (Qn = Qn ?? document.getElementsByTagName("object")),
        (Gn = Gn ?? document.getElementsByTagName("embed"));
      for (const e of Array.from(Qn))
        if (Pn.isInterdictable(e)) {
          const n = Pn.fromNativeObjectElement(e);
          e.replaceWith(n);
        }
      for (const e of Array.from(Gn))
        if (Fn.isInterdictable(e)) {
          const n = Fn.fromNativeEmbedElement(e);
          e.replaceWith(n);
        }
    } catch (e) {
      console.error(
  ...
  function nt() {
    (Yn = Yn ?? document.getElementsByTagName("iframe")),
      (Xn = Xn ?? document.getElementsByTagName("frame")),
      [Yn, Xn].forEach((e) => {
        for (const n of e) {
          ...
          try {
            "complete" === e.document.readyState && tt(e, t);
          } catch (e) {
            Ie || console.warn(t + e);
          }
          n.addEventListener(
  ...
  async function tt(e, n) {
    ...
    try {
      if (((t = e.document), !t)) return;
    } catch (e) {
      return void (Ie || console.warn(n + e));
    }
    if (Ie || void 0 === t.documentElement.dataset.ruffleOptout)
      if (Ie)
        ...
        n.setAttribute("src", Zn),
          (n.onload = () => {
            (e.RufflePlayer = {}), (e.RufflePlayer.config = Kn);
          }),
  ...
  function at() {
    !(function (e) {
      ...
      ("install" in navigator.plugins && navigator.plugins.install) ||
        (Object.defineProperty(window, "PluginArray", { value: Hn }),
        Object.defineProperty(navigator, "plugins", {
          value: new Hn(navigator.plugins),
          writable: !1,
        })),
        navigator.plugins.install(e),
        !(e.length > 0) ||
          ("install" in navigator.mimeTypes && navigator.mimeTypes.install) ||
          (Object.defineProperty(window, "MimeTypeArray", { value: _n }),
          Object.defineProperty(window, "MimeType", { value: Bn }),
          Object.defineProperty(navigator, "mimeTypes", {
            value: new _n(navigator.mimeTypes),
            writable: !1,
          }));
  ...
  const ot = {
    version: l.versionNumber + "+" + l.buildDate.substring(0, 10),
    polyfill() {
      rt();
    },
    pluginPolyfill() {
  ...
  !(function (e, n = {}) {
    let t;
    window.RufflePlayer instanceof s
      ? (t = window.RufflePlayer)
      : ((t = new s(window.RufflePlayer)), (window.RufflePlayer = t)),
      (t.sources[e] = ot),
      (ot.options = n),
      !1 !== (!("polyfills" in t.config) || t.config.polyfills) &&
        ot.pluginPolyfill();
  })("local", {
    onFirstLoad: () => {
      r.p = (function (e) {
