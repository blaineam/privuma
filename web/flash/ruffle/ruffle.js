(() => {
      ...
      136: (e, n, t) => {
        ...
        n.setAttributes = function (e, n) {
          for (const t of Object.keys(n)) {
            if ("__source" === t || "__self" === t || "tsxTag" === t) continue;
            const i = n[t];
            if ("class" === t) {
              ...
              "style" === t && "string" != typeof i
                ...
                : "dangerouslySetInnerHTML" === t
                  ...
                  : !0 === i
                    ? e.setAttribute(t, t)
                    : (i || 0 === i) && e.setAttribute(t, i.toString());
          }
        };
      },
      836: (e, n) => {
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
          ...
          (n.applyTsxTag = function (e, n) {
            ...
            return (
              ...
              { finalTag: t, finalAttrs: a }
            );
          });
      },
      791: (e, n, t) => {
        e.exports = t.p + "f14cd019745b826d8724.wasm";
      },
      797: (e, n, t) => {
        e.exports = t.p + "e706bb3071547287dd75.wasm";
      },
    },
    a = {};
  function r(e) {
  ...
  (r.m = t),
    ...
    (r.u = (e) =>
      "core.ruffle." +
      { 69: "e7a3e81b90a33d85f1a7", 655: "3334b93f92b5c7b428f2" }[e] +
      ".js"),
    (r.g = (function () {
  ...
  const l = {
    versionNumber: "0.1.0",
    versionName: "nightly 2024-10-16",
    versionChannel: "nightly",
    buildDate: "2024-10-16T00:06:12.075Z",
    commitHash: "ba191b3852562c2e7ca658973bcd8bbc8a89d497",
  };
  var u,
    c,
    d,
  ...
  const k = {
    ...
    letterbox: c.Fullscreen,
    unmuteOverlay: d.Visible,
    upgradeToHttps: !0,
    ...
    openUrlMode: g.Allow,
    allowNetworking: b.All,
    openInNewTab: null,
    socketProxy: [],
    fontSources: [],
    defaultFonts: {},
    credentialAllowList: [],
    playerRuntime: v.FlashPlayer,
  };
  class y {
    constructor(e) {
      this.value = e;
  ...
  function C(e, n, t) {
    if (t === n) return !0;
    if (t instanceof x && n instanceof x && t.value === n.value) return !0;
    if (n instanceof x && "string" == typeof t) {
  ...
  function A(e, n, t) {
    return n[t]
      ? P(e, n[t].value)
      : (e.reportError(new RangeError("No default")), new R());
  }
  function q(e, n) {
    const t = [],
      a = Object.create(null);
    for (const r of n)
      "narg" === r.type ? (a[r.name] = F(e, r.value)) : t.push(F(e, r));
  ...
  function F(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new x(n.value, { minimumFractionDigits: n.precision });
      case "var":
        return (function (e, { name: n }) {
          ...
          switch (typeof t) {
            ...
            case "number":
              return new x(t);
            case "object":
              if (t instanceof Date) return new z(t.getTime());
            default:
              return (
                e.reportError(
                  new TypeError(
      ...
      case "mesg":
        return (function (e, { name: n, attr: t }) {
          ...
          if (a.value) return P(e, a.value);
          return e.reportError(new ReferenceError(`No value: ${n}`)), new R(n);
        })(e, n);
      case "term":
        return (function (e, { name: n, attr: t, args: a }) {
          ...
          if (!o)
            return (
              e.reportError(new ReferenceError(`Unknown term: ${r}`)), new R(r)
            );
          if (t) {
      ...
      case "func":
        return (function (e, { name: n, args: t }) {
          ...
          try {
            ...
            return e.reportError(t), new R(`${n}()`);
          }
        })(e, n);
      case "select":
        return (function (e, { selector: n, variants: t, star: a }) {
          let r = F(e, n);
          if (r instanceof R) return A(e, t, a);
          for (const n of t) {
            if (C(e, r, F(e, n.key))) return P(e, n.value);
          }
          return A(e, t, a);
        })(e, n);
      default:
  ...
  function D(e, n) {
    if (e.dirty.has(n))
      return e.reportError(new RangeError("Cyclic reference")), new R();
    e.dirty.add(n);
    const t = [],
      a = e.bundle._useIsolating && n.length > 1;
    for (const r of n)
      if ("string" != typeof r) {
        if ((e.placeables++, e.placeables > j))
          throw (
            (e.dirty.delete(n),
            new RangeError(
              `Too many placeables expanded: ${e.placeables}, max allowed is ${j}`,
            ))
          );
        a && t.push(S), t.push(F(e, r).toString(e)), a && t.push(E);
  ...
  function I(e, n) {
    let t = e[0];
    if (t instanceof R) return new R(`NUMBER(${t.valueOf()})`);
    if (t instanceof x) return new x(t.valueOf(), { ...t.opts, ...$(n, M) });
    if (t instanceof z) return new x(t.valueOf(), { ...$(n, M) });
  ...
  function W(e, n) {
    let t = e[0];
    if (t instanceof R) return new R(`DATETIME(${t.valueOf()})`);
    if (t instanceof z) return new z(t.valueOf(), { ...t.opts, ...$(n, T) });
    if (t instanceof x) return new z(t.valueOf(), { ...$(n, T) });
  ...
  class _ {
    constructor(
      ...
      (this._terms = new Map()),
        ...
        (this._functions = { NUMBER: I, DATETIME: W, ...n }),
        (this._useIsolating = t),
        (this._transform = a),
        (this._intls = (function (e) {
          const n = Array.isArray(e) ? e.join(" ") : e;
          let t = L.get(n);
          return void 0 === t && ((t = new Map()), L.set(n, t)), t;
        })(e));
    }
    hasMessage(e) {
    ...
    formatPattern(e, n = null, t = null) {
      ...
      try {
        ...
        if (a.errors && e instanceof Error)
          return a.errors.push(e), new R().toString(a);
        throw e;
      }
    }
  }
  const U = /^(-?[a-zA-Z][\w-]*) *= */gm,
    ...
    J = /(-?[0-9]+(?:\.([0-9]+))?)/y,
    H = /([a-zA-Z][\w-]*)/y,
    V = /([$-])?([a-zA-Z][\w-]*)(?:\.([a-zA-Z][\w-]*))?/y,
    Z = /^[A-Z][A-Z0-9_-]*$/,
    K = /([^{}\n\r]+)/y,
    Q = /([^\\"\n\r]*)/y,
    G = /\\([\\"])/y,
    Y = /\\u([a-fA-F0-9]{4})|\\U([a-fA-F0-9]{6})/y,
    X = /^\n+/,
    ee = / +$/,
    ne = / *\r?\n/g,
    te = /( *)$/,
  ...
  class fe {
    constructor(e) {
      ...
      function u(a = [], r) {
        ...
        let o = a.length - 1,
          s = a[o];
        "string" == typeof s && (a[o] = b(s, ee));
        let l = [];
        for (let e of a)
          e instanceof me && (e = e.value.slice(0, e.value.length - r)),
            e && l.push(e);
        return l;
      }
      function c() {
        ...
        if (r(le)) {
          ...
          return r(re, SyntaxError), { type: "select", selector: e, ...n };
        }
  ...
  class he {
    ...
    addLikelySubtags() {
      const e = (function (e) {
        if (Object.prototype.hasOwnProperty.call(ve, e)) return new he(ve[e]);
        const n = new he(e);
        if (n.language && ge.includes(n.language))
  ...
  function be(e, n, { strategy: t = "filtering", defaultLocale: a } = {}) {
    const r = (function (e, n, t) {
      const a = new Set(),
        r = new Map();
      for (let e of n) new he(e).isWellFormed && r.set(e, new he(e));
      e: for (const n of e) {
  ...
  const we = {
    ...
    ke = {};
  for (const [e, n] of Object.entries(we)) {
    const t = new _(e);
    if (n)
      for (const [a, r] of Object.entries(n))
        if (r)
          for (const n of t.addResource(new fe(r)))
  ...
  function Re(e, n) {
    const t = be(navigator.languages, Object.keys(ke), {
      defaultLocale: "en-US",
    });
    for (const a in t) {
      const r = ye(t[a], e, n);
  ...
  const ze = navigator.userAgent.includes("Mac OS X") ? "Command" : "Ctrl";
  const je = document.createElement("template");
  je.content.appendChild(
    (0, w.jsx)(function () {
      return (0, w.jsx)("style", {
        children:
    ...
    je.content.appendChild(
      (0, w.jsx)(function () {
        return (0, w.jsx)("style", { id: "dynamic-styles" });
      }, {}),
    ),
    je.content.appendChild(
      (0, w.jsx)(function () {
      ...
      (0, w.jsx)(function () {
        return (0, w.jsxs)("div", {
          ...
          children: [
            ...
            (0, w.jsx)("div", {
              class: "loadbar",
              children: (0, w.jsx)("div", { class: "loadbar-inner" }),
            }),
          ],
        });
      }, {}),
      ...
      (0, w.jsx)(function () {
        return (0, w.jsx)("div", {
          ...
          children: (0, w.jsxs)("div", {
            ...
            class: "modal-area",
            children: [
              (0, w.jsx)("span", { class: "close-modal" }),
              (0, w.jsx)("div", {
                class: "general-save-options",
                children: (0, w.jsx)("span", { class: "modal-button" }),
              }),
              (0, w.jsx)("table", { id: "local-saves" }),
            ],
          }),
        });
      }, {}),
        ...
        return (0, w.jsx)("div", {
          ...
          children: (0, w.jsx)("div", {
            ...
            children: (0, w.jsxs)("div", {
              id: "volume-controls",
              children: [
                (0, w.jsx)("input", { id: "mute-checkbox", type: "checkbox" }),
                (0, w.jsx)("label", {
                  id: "volume-mute",
                  for: "mute-checkbox",
                  title: Re("volume-controls-unmute"),
                }),
                (0, w.jsx)("label", {
                  id: "volume-min",
                  for: "mute-checkbox",
                  title: Re("volume-controls-mute"),
                }),
                (0, w.jsx)("label", {
                  id: "volume-mid",
                  for: "mute-checkbox",
                ...
                (0, w.jsx)("span", { id: "volume-slider-text" }),
                (0, w.jsx)("span", { class: "close-modal" }),
              ],
            }),
          }),
      ...
      (0, w.jsx)(function () {
        return (0, w.jsx)("div", {
          ...
          children: (0, w.jsxs)("div", {
            ...
            children: [
              (0, w.jsx)("span", { class: "close-modal" }),
              (0, w.jsx)("h2", { children: Re("clipboard-message-title") }),
              (0, w.jsx)("p", { id: "clipboard-modal-description" }),
              (0, w.jsxs)("p", {
                children: [
                  (0, w.jsxs)("b", { children: [ze, "+C"] }),
                  (0, w.jsx)("span", {
                    children: Re("clipboard-message-copy"),
                  }),
                ],
              }),
              (0, w.jsxs)("p", {
                children: [
                  (0, w.jsxs)("b", { children: [ze, "+X"] }),
                  (0, w.jsx)("span", { children: Re("clipboard-message-cut") }),
                ],
              }),
              (0, w.jsxs)("p", {
                children: [
                  (0, w.jsxs)("b", { children: [ze, "+V"] }),
                  (0, w.jsx)("span", {
                    children: Re("clipboard-message-paste"),
                  }),
                ],
              }),
            ],
    ...
    je.content.appendChild(
      (0, w.jsx)(function () {
        return (0, w.jsx)("div", {
          ...
          class: "hidden",
          children: (0, w.jsx)("ul", { id: "context-menu" }),
        });
      }, {}),
    );
  const Se = "application/x-shockwave-flash",
    Ee = "application/futuresplash",
    Ce = "application/x-shockwave-flash2-preview",
    Ae = "application/vnd.adobe.flash.movie";
  function qe(e, n) {
    const t = (function (e) {
      let n = "";
      try {
  ...
  try {
    if (
      ...
      e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        (Fe = new URL(".", e)),
        (De = Fe.protocol.includes("extension"));
    }
  } catch (e) {
    console.warn("Unable to get currentScript URL");
  }
  const Pe = "https://ruffle.rs";
  class Oe extends Error {
    constructor(e) {
      super(`Failed to fetch ${e}`), (this.swfUrl = e), (this.swfUrl = e);
    }
  }
  ...
  const Le = {
    OpenDemo: {
      type: "open_link",
      url: Pe + "/demo",
      label: Re("ruffle-demo"),
    },
    DownloadDesktop: {
      type: "open_link",
      url: Pe + "/downloads#desktop-app",
      label: Re("ruffle-desktop"),
    },
    UpdateRuffle: {
      type: "open_link",
      url: Pe + "/downloads",
      label: Re("update-ruffle"),
    },
    CreateReport: { type: "create_report" },
    ShowDetails: { type: "show_details" },
    createReportOrUpdate() {
      return We() ? this.UpdateRuffle : this.CreateReport;
    },
    openWiki: (e, n) => ({
      type: "open_link",
      url: `https://github.com/ruffle-rs/ruffle/wiki/${e}`,
      label: n ?? Re("ruffle-wiki"),
    }),
  };
  function _e(e, n, t, a) {
    const r = t.join("");
    let { body: o, actions: i } = (function (e) {
      if (e instanceof Oe)
        return e.swfUrl && !e.swfUrl.protocol.includes("http")
          ? {
              body: xe("error-file-protocol"),
              actions: [Le.OpenDemo, Le.DownloadDesktop],
            }
          : window.location.origin === e.swfUrl?.origin ||
              window.location.protocol.includes("extension")
            ? { body: xe("error-swf-fetch"), actions: [Le.ShowDetails] }
            : {
                body: xe("error-swf-cors"),
                actions: [
                  Le.openWiki("Using-Ruffle#configure-cors-header"),
                  Le.ShowDetails,
                ],
              };
      if (e instanceof $e)
        return { body: xe("error-invalid-swf"), actions: [Le.ShowDetails] };
      if (e instanceof Me) {
        ...
        if (n.includes("mime"))
          return {
            body: xe("error-wasm-mime-type"),
            actions: [
              Le.openWiki("Using-Ruffle#configure-webassembly-mime-type"),
              Le.ShowDetails,
            ],
          };
        if (n.includes("networkerror") || n.includes("failed to fetch"))
          return {
            body: xe("error-wasm-cors"),
            actions: [
              Le.openWiki("Using-Ruffle#configure-cors-header"),
              Le.ShowDetails,
            ],
        ...
        if (n.includes("disallowed by embedder"))
          return {
            body: xe("error-csp-conflict"),
            actions: [
              Le.openWiki("Using-Ruffle#configure-wasm-csp"),
              Le.ShowDetails,
            ],
          };
        if ("CompileError" === e.cause.name)
          return {
            body: xe("error-wasm-invalid"),
            actions: [
              Le.openWiki("Using-Ruffle#addressing-a-compileerror"),
              Le.ShowDetails,
            ],
          };
        if (
          ...
          return { body: xe("error-wasm-download"), actions: [Le.ShowDetails] };
        if ("TypeError" === e.cause.name) {
          const e = xe("error-javascript-conflict");
          return (
            We() &&
              e.appendChild(
                xe("error-javascript-conflict-outdated", {
                  buildDate: l.buildDate,
                }),
              ),
            { body: e, actions: [Le.createReportOrUpdate(), Le.ShowDetails] }
          );
        }
        return navigator.userAgent.includes("Edg") &&
          n.includes("webassembly is not defined")
          ? {
              body: xe("error-wasm-disabled-on-edge"),
              actions: [
                Le.openWiki(
          ...
          : {
              body: xe("error-wasm-not-found"),
              actions: [
                Le.openWiki("Using-Ruffle#configuration-options"),
                Le.ShowDetails,
              ],
            };
      }
      return e instanceof Ie
        ? {
            body: xe("error-javascript-config"),
            actions: [
              Le.openWiki("Using-Ruffle#javascript-api"),
              Le.ShowDetails,
            ],
          }
        : {
            body: xe("error-unknown", {
              buildDate: l.buildDate,
              outdated: String(We),
            }),
            actions: [Le.createReportOrUpdate(), Le.ShowDetails],
          };
    })(n);
    const s = (0, Te.createRef)(),
      u = () => {
        s.current.classList.add("details"),
          s.current.replaceChildren(
            (0, w.jsx)("textarea", { readOnly: !0, children: r }),
          );
      };
    (e.textContent = ""),
      e.appendChild(
        (0, w.jsxs)("div", {
          ...
          children: [
            (0, w.jsx)("div", {
              id: "panic-title",
              children: Re("panic-title"),
            }),
            (0, w.jsx)("div", { id: "panic-body", ref: s, children: o }),
            (0, w.jsx)("div", {
              id: "panic-footer",
              children: (0, w.jsx)("ul", {
                children: i.map((e) =>
                    ...
                    if ("show_details" == e.type) {
                      ...
                      return (0, w.jsx)("li", {
                        children: (0, w.jsx)("a", {
                          ...
                          onClick: e,
                          children: Re("view-error-details"),
                        }),
                      });
                    }
                    if ("open_link" == e.type)
  ...
  function Ze() {
    ("function" == typeof Array.prototype.reduce &&
      ...
      ("function" == typeof Window && Ve(Window)) ||
  ...
  async function Qe(e) {
    null === Ke &&
      (Ke = (async function (e) {
        Ze();
        const n = (await Promise.all([Ue(), He(), Be(), Je(), Ne()])).every(
          Boolean,
        );
        n ||
          console.log(
      ...
      for (; a < 999; ) {
        ...
        if (
          ...
          return (
            ...
            (Ge[e] = { class: n, name: t, internalName: e }),
            t
          );
        a += 1;
      }
  ...
  function en(e, n) {
    if (
      (Xe(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      Xe(n.backgroundColor) &&
      ...
      Xe(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps),
      Xe(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules),
      Xe(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      Xe(n.base) && e.setBaseUrl(n.base),
      Xe(n.menu) && e.setShowMenu(n.menu),
      Xe(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      Xe(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      Xe(n.forceAlign) && e.setForceAlign(n.forceAlign),
      Xe(n.quality)
        ...
        : void 0 !== window.orientation &&
          ...
          e.setQuality("low")),
      Xe(n.scale) && e.setScale(n.scale.toLowerCase()),
      Xe(n.forceScale) && e.setForceScale(n.forceScale),
      Xe(n.frameRate) && e.setFrameRate(n.frameRate),
      Xe(n.wmode) && e.setWmode(n.wmode),
      Xe(n.logLevel) && e.setLogLevel(n.logLevel),
      Xe(n.maxExecutionDuration) &&
      ...
      Xe(n.playerVersion) && e.setPlayerVersion(n.playerVersion),
      Xe(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer),
      Xe(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()),
      Xe(n.allowNetworking) &&
        e.setAllowNetworking(n.allowNetworking.toLowerCase()),
      Xe(n.credentialAllowList) &&
        e.setCredentialAllowList(n.credentialAllowList),
      Xe(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime),
      Xe(n.socketProxy))
    )
  ...
  class on {
    constructor(e, n, t) {
      (this.contextMenuForceDisabled = !1),
        ...
        this.shadow.appendChild(je.content.cloneNode(!0)),
      ...
      a &&
        ...
        (a.innerText = Re("save-backup-all")));
      const r = this.unmuteOverlay.querySelector("#unmute-overlay-svg");
      if (r) {
        r.querySelector("#unmute-text").textContent = Re("click-to-unmute");
      }
    ...
    async ensureFreshInstance() {
      ...
      const [e, n] = await Qe(this.onRuffleDownloadProgress.bind(this)).catch(
        (e) => {
      ...
      if (
        ...
        !this.loadedConfig ||
          this.loadedConfig.autoplay === u.On ||
          (this.loadedConfig.autoplay !== u.Off &&
            "running" === this.audioState()))
      ) {
        if ((this.play(), "running" !== this.audioState())) {
          (this.loadedConfig && this.loadedConfig.unmuteOverlay === d.Hidden) ||
          ...
          try {
            (this.loadedConfig = {
              ...
              this.loadedConfig.backgroundColor &&
                this.loadedConfig.wmode !== m.Transparent &&
              ...
              "url" in e
                ? (console.log(`Loading SWF file ${e.url}`),
                  ...
                  this.instance.stream_from(this.swfUrl.href, an(e.parameters)))
                : "data" in e &&
    ...
    confirmReloadSave(e, n, t) {
      if (this.isB64SOL(n) && localStorage[e]) {
        if (!t) {
          if (!confirm(Re("save-delete-prompt"))) return;
        }
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              Re("save-reload-prompt", { action: t ? "replace" : "delete" }),
            ) &&
            this.loadedConfig &&
            (this.destroy(),
    ...
    contextMenuItems() {
      ...
      return (
        this.fullscreenEnabled &&
          (this.isFullscreen
            ? n.push({
                text: Re("context-menu-exit-fullscreen"),
                onClick: async () => this.setFullscreen(!1),
              })
            : n.push({
                text: Re("context-menu-enter-fullscreen"),
                onClick: async () => this.setFullscreen(!0),
              })),
        n.push({
          text: Re("context-menu-volume-controls"),
          onClick: async () => {
        ...
        this.instance &&
          ...
          (t(),
          n.push({
            text: Re("context-menu-download-swf"),
            onClick: this.downloadSwf.bind(this),
          })),
        navigator.clipboard &&
          window.isSecureContext &&
          n.push({
            text: Re("context-menu-copy-debug-info"),
            onClick: () => navigator.clipboard.writeText(this.getPanicData()),
          }),
        this.checkSaves() &&
          n.push({
            text: Re("context-menu-open-save-manager"),
            onClick: this.openSaveManager.bind(this),
          }),
        t(),
        n.push({
          text: Re("context-menu-about-ruffle", {
            flavor: De ? "extension" : "",
    ...
    showContextMenu(e) {
      ...
      if (
        ("contextmenu" === e.type
          ...
          : (document.documentElement.addEventListener(
            ...
            e.stopPropagation()),
        [!1, h.Off].includes(this.loadedConfig?.contextMenu ?? h.On) ||
          (this.isTouch &&
            this.loadedConfig?.contextMenu === h.RightClickOnly) ||
      ...
      const n = this.element.getBoundingClientRect(),
        ...
        a = Math.max(
          0,
          e.clientX + t.width - document.documentElement.clientWidth,
        ),
        r = Math.max(
          0,
          e.clientY + t.height - document.documentElement.clientHeight,
        ),
        o = e.clientX - n.x - a,
        i = e.clientY - n.y - r;
    ...
    panic(e) {
      ...
      t.push(this.getPanicData()),
        _e(this.container, n, t, this.swfUrl),
        this.destroy();
    }
    addOpenInNewTabMessage(e, n) {
      ...
      (r.className = "message"), r.appendChild(xe("message-cant-embed"));
      const o = document.createElement("div"),
        i = document.createElement("a");
      (i.innerText = Re("open-in-new-tab")),
        (i.onclick = () => e(t)),
        o.appendChild(i),
        r.appendChild(o),
        a.appendChild(r),
    ...
    displayRootMovieDownloadFailedMessage(e) {
      ...
      if (n && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        ...
        const n = e ? new $e(this.swfUrl) : new Oe(this.swfUrl);
        this.panic(n);
      }
    }
    displayMessage(e) {
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = Re("clipboard-message-description", {
            ...
            (e) => {
              try {
                Object.defineProperty(this, e, {
                  value: (...n) =>
                    vn(this, hn, "f").callExternalInterface(e, n),
                  configurable: !0,
                });
              } catch (n) {
                console.warn(
  ...
  class kn extends bn {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !fn(e) && (cn(n) ? (dn(e, "src"), !1) : qe(n, t));
    }
    static fromNativeEmbedElement(e) {
      const n = Ye("ruffle-embed", kn),
  ...
  class Rn extends bn {
    ...
    connectedCallback() {
      super.connectedCallback(), (this.params = yn(this));
      let e = null;
      if (
  ...
  async function On(e, n) {
    ...
    try {
      ...
      return void (De || console.warn(n + e));
    }
    if (De || void 0 === t.documentElement.dataset.ruffleOptout)
      if (De)
        e.RufflePlayer || (e.RufflePlayer = {}),
          (e.RufflePlayer.config = { ...Sn, ...(e.RufflePlayer.config ?? {}) });
      else if (!e.RufflePlayer) {
        const n = t.createElement("script");
        n.setAttribute("src", En),
          (n.onload = () => {
            (e.RufflePlayer = {}), (e.RufflePlayer.config = Sn);
          }),
  ...
  function Mn() {
    (("favorFlash" in Sn && !1 === Sn.favorFlash) ||
      "ruffle.js" ===
